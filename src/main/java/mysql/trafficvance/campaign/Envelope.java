...
public class Envelope extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 452168336110273299L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Envelope\",\"namespace\":\"mysql.trafficvance.campaign\",\"fields\":[{\"name\":\"before\",\"type\":[\"null\",{\"type\":\"record\",\"name\":\"Value\",\"fields\":[{\"name\":\"campaign_id\",\"type\":\"long\"},{\"name\":\"advertiser_id\",\"type\":\"long\"},{\"name\":\"campaign_status\",\"type\":\"string\"}],\"connect.name\":\"mysql.trafficvance.campaign.Value\"}],\"default\":null},{\"name\":\"after\",\"type\":[\"null\",\"Value\"],\"default\":null},{\"name\":\"source\",\"type\":{\"type\":\"record\",\"name\":\"Source\",\"namespace\":\"io.debezium.connector.mysql\",\"fields\":[{\"name\":\"version\",\"type\":[\"null\",\"string\"],\"default\":null},{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"server_id\",\"type\":\"long\"},{\"name\":\"ts_sec\",\"type\":\"long\"},{\"name\":\"gtid\",\"type\":[\"null\",\"string\"],\"default\":null},{\"name\":\"file\",\"type\":\"string\"},{\"name\":\"pos\",\"type\":\"long\"},{\"name\":\"row\",\"type\":\"int\"},{\"name\":\"snapshot\",\"type\":[\"null\",\"boolean\"],\"default\":null},{\"name\":\"thread\",\"type\":[\"null\",\"long\"],\"default\":null},{\"name\":\"db\",\"type\":[\"null\",\"string\"],\"default\":null},{\"name\":\"table\",\"type\":[\"null\",\"string\"],\"default\":null}],\"connect.name\":\"io.debezium.connector.mysql.Source\"}},{\"name\":\"op\",\"type\":\"string\"},{\"name\":\"ts_ms\",\"type\":[\"null\",\"long\"],\"default\":null}],\"connect.name\":\"mysql.trafficvance.campaign.Envelope\"}");
  ...
  @Deprecated public mysql.trafficvance.campaign.Value before;
  @Deprecated public mysql.trafficvance.campaign.Value after;
   ...
   */
  public Envelope(mysql.trafficvance.campaign.Value before, mysql.trafficvance.campaign.Value after, io.debezium.connector.mysql.Source source, java.lang.CharSequence op, java.lang.Long ts_ms) {
    this.before = before;
    this.after = after;
    this.source = source;
    this.op = op;
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: before = (mysql.trafficvance.campaign.Value)value$; break;
    case 1: after = (mysql.trafficvance.campaign.Value)value$; break;
   ...
   */
  public mysql.trafficvance.campaign.Value getBefore() {
    return before;
  }
   ...
   */
  public void setBefore(mysql.trafficvance.campaign.Value value) {
    this.before = value;
  }
   ...
   */
  public mysql.trafficvance.campaign.Value getAfter() {
    return after;
  }
   ...
   * @param value the value to set.
   */
  public void setAfter(mysql.trafficvance.campaign.Value value) {
    this.after = value;
  }
   ...
   */
  public static mysql.trafficvance.campaign.Envelope.Builder newBuilder() {
    return new mysql.trafficvance.campaign.Envelope.Builder();
  }
   ...
   * @return A new Envelope RecordBuilder
   */
  public static mysql.trafficvance.campaign.Envelope.Builder newBuilder(mysql.trafficvance.campaign.Envelope.Builder other) {
    return new mysql.trafficvance.campaign.Envelope.Builder(other);
  }
   ...
   * @return A new Envelope RecordBuilder
   */
  public static mysql.trafficvance.campaign.Envelope.Builder newBuilder(mysql.trafficvance.campaign.Envelope other) {
    return new mysql.trafficvance.campaign.Envelope.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Envelope>
    ...
    private mysql.trafficvance.campaign.Value before;
    private mysql.trafficvance.campaign.Value.Builder beforeBuilder;
    private mysql.trafficvance.campaign.Value after;
    private mysql.trafficvance.campaign.Value.Builder afterBuilder;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(mysql.trafficvance.campaign.Envelope.Builder other) {
      super(other);
      ...
      if (other.hasBeforeBuilder()) {
        this.beforeBuilder = mysql.trafficvance.campaign.Value.newBuilder(other.getBeforeBuilder());
      }
      ...
      if (other.hasAfterBuilder()) {
        this.afterBuilder = mysql.trafficvance.campaign.Value.newBuilder(other.getAfterBuilder());
      }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(mysql.trafficvance.campaign.Envelope other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.before)) {
        this.before = data().deepCopy(fields()[0].schema(), other.before);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public mysql.trafficvance.campaign.Envelope.Builder setBefore(mysql.trafficvance.campaign.Value value) {
     ...
     * @return This builder.
     */
    public mysql.trafficvance.campaign.Value.Builder getBeforeBuilder() {
      if (beforeBuilder == null) {
        if (hasBefore()) {
          setBeforeBuilder(mysql.trafficvance.campaign.Value.newBuilder(before));
        } else {
          setBeforeBuilder(mysql.trafficvance.campaign.Value.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public mysql.trafficvance.campaign.Envelope.Builder setBeforeBuilder(mysql.trafficvance.campaign.Value.Builder value) {
      clearBefore();
      beforeBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public mysql.trafficvance.campaign.Envelope.Builder clearBefore() {
      before = null;
      beforeBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public mysql.trafficvance.campaign.Envelope.Builder setAfter(mysql.trafficvance.campaign.Value value) {
     ...
     * @return This builder.
     */
    public mysql.trafficvance.campaign.Value.Builder getAfterBuilder() {
      if (afterBuilder == null) {
        if (hasAfter()) {
          setAfterBuilder(mysql.trafficvance.campaign.Value.newBuilder(after));
        } else {
          setAfterBuilder(mysql.trafficvance.campaign.Value.newBuilder());
        }
      }
      return afterBuilder;
    }
     ...
     * @return This builder.
     */
    public mysql.trafficvance.campaign.Envelope.Builder setAfterBuilder(mysql.trafficvance.campaign.Value.Builder value) {
      clearAfter();
      afterBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public mysql.trafficvance.campaign.Envelope.Builder clearAfter() {
      after = null;
      afterBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public mysql.trafficvance.campaign.Envelope.Builder setSource(io.debezium.connector.mysql.Source value) {
     ...
     * @return This builder.
     */
    public mysql.trafficvance.campaign.Envelope.Builder setSourceBuilder(io.debezium.connector.mysql.Source.Builder value) {
      clearSource();
      sourceBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public mysql.trafficvance.campaign.Envelope.Builder clearSource() {
      source = null;
      sourceBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public mysql.trafficvance.campaign.Envelope.Builder setOp(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public mysql.trafficvance.campaign.Envelope.Builder clearOp() {
      op = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public mysql.trafficvance.campaign.Envelope.Builder setTsMs(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public mysql.trafficvance.campaign.Envelope.Builder clearTsMs() {
      ts_ms = null;
    ...
    public Envelope build() {
      try {
        ...
        if (beforeBuilder != null) {
          ...
          record.before = fieldSetFlags()[0] ? this.before : (mysql.trafficvance.campaign.Value) defaultValue(fields()[0]);
        }
        if (afterBuilder != null) {
          record.after = this.afterBuilder.build();
        } else {
          record.after = fieldSetFlags()[1] ? this.after : (mysql.trafficvance.campaign.Value) defaultValue(fields()[1]);
        }
        if (sourceBuilder != null) {
