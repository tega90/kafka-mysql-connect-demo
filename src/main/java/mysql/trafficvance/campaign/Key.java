...
public class Key extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 1259424466675414627L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Key\",\"namespace\":\"mysql.trafficvance.campaign\",\"fields\":[{\"name\":\"campaign_id\",\"type\":\"long\"}],\"connect.name\":\"mysql.trafficvance.campaign.Key\"}");
   ...
   */
  public Key(java.lang.Long campaign_id) {
   ...
   */
  public static mysql.trafficvance.campaign.Key.Builder newBuilder() {
    return new mysql.trafficvance.campaign.Key.Builder();
  }
   ...
   * @return A new Key RecordBuilder
   */
  public static mysql.trafficvance.campaign.Key.Builder newBuilder(mysql.trafficvance.campaign.Key.Builder other) {
    return new mysql.trafficvance.campaign.Key.Builder(other);
  }
   ...
   * @return A new Key RecordBuilder
   */
  public static mysql.trafficvance.campaign.Key.Builder newBuilder(mysql.trafficvance.campaign.Key other) {
    return new mysql.trafficvance.campaign.Key.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Key>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(mysql.trafficvance.campaign.Key.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(mysql.trafficvance.campaign.Key other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.campaign_id)) {
        this.campaign_id = data().deepCopy(fields()[0].schema(), other.campaign_id);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public mysql.trafficvance.campaign.Key.Builder setCampaignId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public mysql.trafficvance.campaign.Key.Builder clearCampaignId() {
